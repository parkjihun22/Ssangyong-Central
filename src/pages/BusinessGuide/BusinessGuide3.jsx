  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        {/* SEO 최적화를 위한 메타 태그 */}
        <title>천안 쌍용 센트럴타워 - 계약서류안내</title>
        <meta
          name="description"
        ...
        />
        <link rel="canonical" href="https://www.daincounseling.co.kr/BusinessGuide/documents" />

        {/* Open Graph - 소셜 미디어 공유 최적화 */}
        <meta property="og:title" content="천안 쌍용 센트럴타워 - 계약서류안내" />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.daincounseling.co.kr/BusinessGuide/documents"
        />
        ...
        <script type="application/ld+json">
          {`
						...
						"url": "https://www.daincounseling.co.kr/BusinessGuide/documents"
								}
								`}
        </script>
      </Helmet>
