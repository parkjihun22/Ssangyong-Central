  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        {/* SEO 최적화를 위한 메타 태그 */}
        <title>회천중앙역 로제비앙그랜드센텀 - 홍보영상</title>
        <meta
          name="description"
        ...
        />
        <link rel="canonical" href="https://www.daincounseling.co.kr/Brand/video" />

        {/* Open Graph - 소셜 미디어 공유 최적화 */}
        <meta property="og:title" content="회천중앙역 로제비앙그랜드센텀 - 홍보영상" />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.daincounseling.co.kr/Brand/video"
        />
          ...
          {`
															{
																...
																"url": "https://www.daincounseling.co.kr/Brand/video"
															}
															`}
        </script>
      </Helmet>
      ...
      <h1 className={styles.screenReaderOnly}>
        회천중앙역 로제비앙그랜드센텀 - 홍보영상
      </h1>
      <p className={styles.screenReaderOnly}>
        회천중앙역 로제비앙그랜드센텀의 홍보 영상은 이 프로젝트의 주요 특징과 장점을
        시각적으로 잘 전달하는 매체입니다. 고품질의 영상으로 이 단지의 설계,
        입지, 편의 시설 등 다양한 요소를 소개하며, 분양을 고민하는 고객들에게
        유익한 정보를 제공합니다. 영상 시청을 통해 회천중앙역 로제비앙그랜드센텀의 매력을
        더 깊이 이해할 수 있습니다.
      </p>
      ...
      >
        <div>회천중앙역 로제비앙그랜드센텀가 눈부신 가치 위에</div>
