  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        <meta property="og:title" content="천안 쌍용 센트럴타워 - 홍보영상" />
        <meta
      ...
      <p className={styles.screenReaderOnly}>
        천안 쌍용 센트럴타워의 홍보 영상은 이 프로젝트의 주요 특징과 장점을
        시각적으로 잘 전달하는 매체입니다. 고품질의 영상으로 이 단지의 설계,
        입지, 편의 시설 등 다양한 요소를 소개하며, 분양을 고민하는 고객들에게
        유익한 정보를 제공합니다. 영상 시청을 통해 천안 쌍용 센트럴타워의 매력을
        더 깊이 이해할 수 있습니다.
      </p>
      ...
      >
        <div>천안 쌍용 센트럴타워가 눈부신 가치 위에</div>
