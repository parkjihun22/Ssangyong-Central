  ...
  return (
    <div className={styles.container}>
      ...
      <p className={styles.screenReaderOnly}>
        천안 쌍용 센트럴타워의 입지 안내 페이지는 이 단지의 위치와 주변 인프라에
      ...
      <div className={styles.textBox}>
        ...
        <div>살수록 높아질 </div>
        <div>도시를 압도할 자부심천안 쌍용 센트럴타워</div>
      </div>

      <img
        src={page1}
        className={styles.image2}
        alt="천안 쌍용 센트럴타워입지안내-image1"
      />
